 ...
 */
// Gerber 단위(MILLIMETER, INCH)에 따라 픽셀 크기를 계산
...
// 현재 선택된 아퍼처(Aperture)의 다각형을 좌표 (x, y)에 추가
...
//  the drawing
// RS-274X 포맷 문자열에서 좌표 값을 추출하고 반환
...
//--------------------------------------------------------------------------------------------------
// Gerber 파일에서 AD(Aperture Definition) 블록을 처리
